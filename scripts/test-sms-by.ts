 ...
 * Run: npx ts-node --project tsconfig.scripts.json scripts/test-sms-by.ts
 * Or:  npx tsx scripts/test-sms-by.ts
 *
 * Set TEST_PHONE env var to your real number, e.g.:
 *   TEST_PHONE=375447777405 npx tsx scripts/test-sms-by.ts
 */
