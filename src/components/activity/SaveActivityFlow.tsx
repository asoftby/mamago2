...
export type SaveActivityFlowProps = {
  open: boolean;
...
/**
 * Единый flow в одном bottom sheet (и на мобиле, и на десктопе — без второго Dialog).
 * Шаги: выбор → при необходимости вход (без вложенной «карточки») → успех.
 */
export function SaveActivityFlow({
  open,
  onOpenChange,
  isAuthenticated,
  scenario,
  ...
  }, [pending, onOpenChange, runPersist]);
