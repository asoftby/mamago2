  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:pointer-events-none fixed z-[70] flex flex-col gap-4 shadow-lg transition ease-in-out pointer-events-auto data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
