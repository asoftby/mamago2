...
export class OfferCommitWriter {
  ...
  async createOfferFromDraft(draft: OfferCreateDraft): Promise<OfferCommitWriteResult> {
    ...
    // despite a resolved, evidence-backed city always being available.
    const data: Prisma.OfferUncheckedCreateInput = { placeId: draft.placeId, createRequestId: draft.createRequestId, kind: draft.kind, productType: draft.productType, title: draft.title, description: draft.description, status: "DRAFT", cityId: draft.ownership.cityId, priceFrom: draft.priceFrom, priceText: draft.priceText, agePolicy: draft.ageMinMonths != null || draft.ageMaxMonths != null ? "SPECIFIC" : "UNKNOWN", ageMinMonths: draft.ageMinMonths, ageMaxMonths: draft.ageMaxMonths, contactPhone: draft.contactPhone, contactWebsite: draft.contactWebsite, seoTitle: draft.seoTitle, seoDescription: draft.seoDescription, seoCanonicalUrl: draft.seoCanonicalUrl, seoRobots: draft.seoRobots, seoOgTitle: draft.seoOgTitle, seoOgDescription: draft.seoOgDescription };
