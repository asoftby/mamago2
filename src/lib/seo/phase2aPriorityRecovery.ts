...
export const PHASE_2A_PRIORITY_RECOVERIES: Phase2ARecoveryEntry[] = [
  ...
  },
  {
    ...
    confidence: "HIGH",
    evidence:
      "Outdoor birthday gazebos guide. Current redirect /minsk/blog/. Same pattern as other birthday articles. CITY by redirect destination.",
  },
  {
    position: 16,
    legacySourcePath:
  ...
  },
  {
    ...
    confidence: "MEDIUM",
    evidence:
      "Summer 2026 recreation guide. Year-specific but seasonal. Current redirect /minsk/blog/. CITY by redirect destination.",
  },
  {
    position: 21,
    ...
    confidence: "MEDIUM",
    evidence:
      "Nanny/babysitter guide. Generic title but current redirect to /minsk/blog/. Evidence insufficient for high confidence but follows existing pattern.",
  },
  {
    position: 22,
