export const BOOST_OPTION_DEFINITIONS = [
  { id: "BOOST_1_DAY", durationDays: 1, envName: "BOOST_PRICE_1D_BYN" },
  { id: "BOOST_3_DAYS", durationDays: 3, envName: "BOOST_PRICE_3D_BYN" },
  { id: "BOOST_7_DAYS", durationDays: 7, envName: "BOOST_PRICE_7D_BYN" },
] as const;
