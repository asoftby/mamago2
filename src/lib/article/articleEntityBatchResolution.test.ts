...
assert.match(source, /await resolveUniqueConcurrently\(/, "all unique OFFER promises must be observed immediately");
assert.match(source, /offerCards\.get\(key\)/, "duplicate OFFER references should reuse their resolved result");
